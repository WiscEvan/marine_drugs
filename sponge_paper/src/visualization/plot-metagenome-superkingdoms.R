...
setwd("~/sponge_paper/sponge_paper/data/interim/host-assembly/fastas/")
...
p
ggsave("~/sponge_paper/sponge_paper/reports/figures/sponge-metagenome-superkingdom-counts.pdf", p)  
