...
shell_template="$HOME/sponge_paper/sponge_paper/src/features/condor_blastp_template.sh"
sub_template="$HOME/sponge_paper/sponge_paper/src/features/condor_blastp_template.sub"
binning="$HOME/sponge_paper/sponge_paper/data/interim/binning"
features="$HOME/sponge_paper/sponge_paper/src/features"
diamond="$HOME/sponge_paper/sponge_paper/src/features/diamond"
