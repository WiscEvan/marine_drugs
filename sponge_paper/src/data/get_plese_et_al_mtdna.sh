...
OUTDIR="/media/BRIANDATA3/kwan-bioinformatics-home-evan/evan/sponge_paper/sponge_paper/data/external/plese_et_al_2021"
mkdir -p $OUTDIR
...
done < /media/BRIANDATA3/kwan-bioinformatics-home-evan/evan/sponge_paper/sponge_paper/data/external/plese_et_al_gbk_accessions.txt
...
src="/media/BRIANDATA3/kwan-bioinformatics-home-evan/evan/sponge_paper/sponge_paper/src/features/mitogenome-retrieval-and-annotation/bin/translate_mtdna_cds_fna.py"
for mtdna_fna in `find /media/BRIANDATA3/kwan-bioinformatics-home-evan/evan/sponge_paper/sponge_paper/data/external/plese_et_al_2021 -name "*.mtdna.cds.fna"`;do
