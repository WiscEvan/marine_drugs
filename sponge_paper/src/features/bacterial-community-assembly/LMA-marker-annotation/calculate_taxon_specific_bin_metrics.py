...
def main():
    ...
    # $HOME/sponge_paper/sponge_paper/data/interim/binning/final_binning_filepaths.tsv
    args = parser.parse_args()

    # "/home/evan/sponge_paper/sponge_paper/data/interim/LMA-marker-annotation/FL2015_4_phylum_Proteobacteria_markers_all_markers.hmmscan.tsv"
    markers_df = read_hmmscan(infpath=args.hmmscan, outfpath=args.output_markers)

    # Read binning to assess metrics
    # binning = "/home/evan/sponge_paper/sponge_paper/data/interim/refined/first_round_of_refinements/before_sams_notes/FL2015_4.bacteria.binning.umap.refined.csv"
