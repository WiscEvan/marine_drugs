...
PREDICTIONS_DIR="$HOME/sponge_paper/sponge_paper/data/interim/host-annotation/gene-calling/ab-initio"
OUTDIR="$HOME/sponge_paper/sponge_paper/data/interim/host-annotation/augustus-ab-initio-proteins-marker-assessment"
if [ ! -d $OUTDIR ];
then
    mkdir -p $OUTDIR
    echo "Created ${OUTDIR}"
