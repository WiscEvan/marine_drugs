...
#SBATCH --error=logs/%J.star_alignment_FL2015_37.err
#SBATCH --output=logs/%J.star_alignment_FL2015_37.out

sponge="FL2015_37"
genome="$HOME/sponge_paper/sponge_paper/data/interim/host-assembly/fastas/${sponge}/eukaryota.fna"
all_reads="$HOME/sponge_paper/sponge_paper/data/interim/rnaseq"
...
genomeDir="$HOME/sponge_paper/sponge_paper/data/interim/host-assembly/star-alignments/seqycleaned-rnaseq/${sponge}"
