...
template="$HOME/sponge_paper/sponge_paper/src/features/host-assembly/seqyclean-alignments/star-alignment-template.sh"
outdir="$HOME/sponge_paper/sponge_paper/src/features/host-assembly/seqyclean-alignments"

sponges_eukaryotic_contigs=`ls -d /home/evan/sponge_paper/sponge_paper/data/interim/host-assembly/fastas/*/`
