...
DEFAULT_TAXA_DIR = os.path.join(HOME, "sponge_paper/sponge_paper/data/interim/binning")
...
def main():
    ...
    # fullpath $HOME/sponge_paper/sponge_paper/data/interim/host-annotation/busco-marker-assessment/FL2015_8_metagenome_busco_genome_metazoa_odb10/run_metazoa_odb10/full_table.tsv
