...
#SBATCH --error=logs/%J.busco_proteins_metazoa_eukaryota.err
#SBATCH --output=logs/%J.busco_proteins_metazoa_eukaryota.out

# Path to directories containing eukaryota.fna fasta files.
PREDICTIONS_DIR="$HOME/sponge_paper/sponge_paper/data/interim/host-annotation/gene-calling"
...
for prediction in `ls ${PREDICTIONS_DIR}/*.hints.predictions.aa`;do
