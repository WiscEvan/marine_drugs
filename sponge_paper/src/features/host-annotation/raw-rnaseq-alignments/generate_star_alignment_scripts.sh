...
template="$HOME/sponge_paper/sponge_paper/src/features/host-assembly/raw-alignments/star-alignment-template.sh"
outdir="$HOME/sponge_paper/sponge_paper/src/features/host-assembly/raw-alignments"
