...
all_reads="$HOME/sponge_paper/sponge_paper/data/raw/rnaseq"
...
genomeDir="$HOME/sponge_paper/sponge_paper/data/interim/host-assembly/star-alignments/raw-alignments/${sponge}"
