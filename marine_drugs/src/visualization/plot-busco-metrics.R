...
setwd("~/marine_drugs/marine_drugs/data/interim/host-annotation/busco-marker-assessment/")
...
p
ggsave("~/marine_drugs/marine_drugs/reports/figures/sponge-marker-completeness-estimation.pdf", p)  
