...
OUTDIR="/media/BRIANDATA3/kwan-bioinformatics-home-evan/evan/marine_drugs/marine_drugs/data/external/lavrov_et_al"
mkdir -p $OUTDIR
...
done < /media/BRIANDATA3/kwan-bioinformatics-home-evan/evan/marine_drugs/marine_drugs/data/external/lavrov_et_al_gbk_accessions.txt
