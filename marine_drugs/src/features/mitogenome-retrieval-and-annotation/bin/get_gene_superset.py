...
def main():
    ...
    parser.add_argument("--indir", default="marine_drugs/data/interim/mitogenomes/concat")
    parser.add_argument("--outdir", default="marine_drugs/data/interim/mitogenomes/cleaned")
