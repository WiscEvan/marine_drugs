...
REPO = "/media/BRIANDATA3/kwan-bioinformatics-home-evan/evan/marine_drugs"
export PATH="$REPO/marine_drugs/src/features/mitogenome-retrieval-and-annotation/bin":$PATH

mitogenomes="$REPO/marine_drugs/marine_drugs/data/interim/mitogenomes"
