...
PREDICTION_DIR="$HOME/marine_drugs/marine_drugs/data/interim/host-annotation/gene-calling"
...
FASTAS="$HOME/marine_drugs/marine_drugs/data/interim/host-assembly/fastas"
