...
template="$HOME/marine_drugs/marine_drugs/src/features/host-assembly/seqyclean-alignments/star-alignment-template.sh"
outdir="$HOME/marine_drugs/marine_drugs/src/features/host-assembly/seqyclean-alignments"
